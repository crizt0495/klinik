...
export function LabOrdersView({ orders }: { orders: LabOrderRow[] }) {
  ...
  return <DataTable columns={columns} data={orders} searchPlaceholder="Cari order lab..." emptyTitle="Tidak ada order" emptyDescription="Belum ada order laboratorium." exportable exportFilename="lab" />;
}